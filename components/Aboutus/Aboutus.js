        ...
        <Row>
          <Col lg={8}>
            <div className={styles.aboutLeft}>
              <h2 data-aos="zoom-in">আমাদের সম্পর্কে</h2>
              <p data-aos="fade-up">
          ...
          <Col lg={4}>
            <div className="aboutRight" data-aos="flip-up">
